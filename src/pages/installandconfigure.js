...
const Idtwo = props => (
    ...
    <Layout>
      ...
      <div>
          ...
          The key part is that they are all "identity" and/or "access" services (and by services they mean an application/program/software/protocol). So ever single item on this list can be used for either authentication ("identity), authorization ("access") or both. In addition, some can do more. <br></br>
          <br></br>
